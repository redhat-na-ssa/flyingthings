...
python3 /usr/local/lib/python3.9/site-packages/yolov5/train.py --img 640 --epochs 3 --data classes.yaml --weights ${SIMPLEVIS_DATA}/workspace/$BASE_MODEL --project ${SIMPLEVIS_DATA}/workspace/runs --exist_ok True