...
mc --config-dir /tmp mb rht/flyingthings-models
mc --config-dir /tmp policy set public rht/flyingthings-models
...
mc --config-dir /tmp mb rht/models-correctivecandidates
mc --config-dir /tmp policy set public rht/models-correctivecandidates
