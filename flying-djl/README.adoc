...
(venv) $ python yolov5/detect.py \
           --source /tmp/org.acme.objectdetection/unAdulteredImage-1690148580.png

detect: weights=yolov5/yolov5s.pt, source=/tmp/org.acme.objectdetection/unAdulteredImage-1690148580.png, data=yolov5/data/coco128.yaml, imgsz=[640, 640], conf_thres=0.25, iou_thres=0.45, max_det=1000, device=, view_img=False, save_txt=False, save_conf=False, save_crop=False, nosave=False, classes=None, agnostic_nms=False, augment=False, visualize=False, update=False, project=yolov5/runs/detect, name=exp, exist_ok=False, line_thickness=3, hide_labels=False, hide_conf=False, half=False, dnn=False, vid_stride=1
...
image 1/1 /tmp/org.acme.objectdetection/unAdulteredImage-1690148580.png: 384x640 1 airplane, 54.5ms
...
(venv) $ python yolov5/detect.py \
         --source https://github.com/ultralytics/yolov5/raw/master/data/images/bus.jpg \
