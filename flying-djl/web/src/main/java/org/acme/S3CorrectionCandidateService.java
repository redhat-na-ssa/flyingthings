    ...
    public boolean postToBucket(String body, String objectName){
        ...
        try {
            ...
            if(putWithTags) {
                ...
                log.infov("uploading object to {0} with following # of tags: {1}", correctiveCandidateBucketName, tags.size());
                pOArgs = (PutObjectArgs) bObj.tags(tags).build();
            } else {
                log.infov("uploading object to {0} with zero tags", correctiveCandidateBucketName);
